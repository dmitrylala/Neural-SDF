...
clean: ## Clean autogenerated files
	...
	rm -rf $(BUILD_DIR) \
		example_tracer/include example_tracer/shaders_generated example_tracer/*generated* \
		nn/include nn/shaders_generated nn/*generated*

build_cpu: ## Configure and build for CPU
	@echo "=== Building for CPU ===="
	cmake -B $(BUILD_DIR) -DCMAKE_BUILD_TYPE=$(BUILD_TYPE)
	cmake --build $(BUILD_DIR) --target train -j8
...
run_train: ## Run train
	...
	./$(BUILD_DIR)/bin/train \
		...
		--hidden_size 64 \
		--batch_size 40 \
		--test_points sdf1_test.bin \
		--weights sdf1_weights.bin